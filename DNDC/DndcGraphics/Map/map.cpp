...
long CMoMap::GetGeometryEnvironment()
{
	long result;
...
void CMoMap::SetGeometryEnvironment(long propVal)
{
	SetProperty(0x2b, VT_I4, propVal);
}

long CMoMap::GetDisplayUnit()
{
	long result;
...
void CMoMap::SetDisplayUnit(long propVal)
{
...
void CMoMap::EnableStreetMap(LPCTSTR licenseCode)
{
	static BYTE parms[] =
		VTS_BSTR;
...
void CMoMap::ExportMapToJpeg(LPCTSTR outputFile, long percentQuality, BOOL isProgressive, double scaleFactor, long scaleSymbology)
{
	static BYTE parms[] =
...
void CMoMap::ExportMap3(long formatType, const VARIANT& formatData, double scaleFactor, long scaleSymbology, long exportDepth, long palette)
{
	static BYTE parms[] =
