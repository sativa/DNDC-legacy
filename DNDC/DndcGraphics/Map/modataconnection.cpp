...
CMoStrings CMoDataConnection::ReturnVersions()
{
	LPDISPATCH pDispatch;
...
CString CMoDataConnection::GetVersion()
{
	CString result;
...
void CMoDataConnection::SetVersion(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
