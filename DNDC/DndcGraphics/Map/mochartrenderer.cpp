...
CString CMoChartRenderer::GetTag()
{
	CString result;
...
void CMoChartRenderer::SetTag(LPCTSTR propVal)
{
	SetProperty(0xe, VT_BSTR, propVal);
}

LPUNKNOWN CMoChartRenderer::GetCustomChart()
{
	LPUNKNOWN result;
	GetProperty(0xf, VT_UNKNOWN, (void*)&result);
	return result;
}

void CMoChartRenderer::SetCustomChart(LPUNKNOWN propVal)
{
	SetProperty(0xf, VT_UNKNOWN, propVal);
}

BOOL CMoChartRenderer::GetDrawBackground()
{
	BOOL result;
...
void CMoChartRenderer::SetDrawBackground(BOOL propVal)
{
	SetProperty(0x10, VT_BOOL, propVal);
}

/////////////////////////////////////////////////////////////////////////////
// CMoChartRenderer operations
