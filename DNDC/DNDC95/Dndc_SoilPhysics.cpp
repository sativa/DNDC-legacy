                            ...
                            int YieldToday, int drc, int scale, float ha, int livestock)
{
    ...
    float Throufall=0.0, hrsoil_ev, dWW, Intercept, hrPonding_ev=0.0, dIT=0.0;
    ...
    {	
        ...
        if(IrriWater>0.0)
        {
            ...
            {
                dIT = 0.2 * day_IrriWater;							
            }
            else if(IrriMethod==2)//drip at 0 cm
            {
                dIT = 0.5 * day_IrriWater;
            }
            else //drip at 5 cm
            {
...
void class_model::hourly_transp_and_water_stress(int hr, int DroughtID, int YieldToday, int drc)
{
        ...
        {	
            ...
            if ( l == 1 )
            {
                if(surf_water>0.0)
                {
                    ...
                    else //if(IrriMethod==1||IrriMethod==2) //sprinkler or surface drip irri
                    {
                        float dWWW = fldcapw - water[hr][l];
                        if(surf_water>=dWWW)
                        {
                            AvaWater = dWWW;
                            surf_water -= dWWW;
                    ...
                    /*else if(IrriMethod==3) //5cm depth drip irri
                    {
                        AvaWater = 0.05 * surf_water;
                        surf_water -= AvaWater;
                    }*/
