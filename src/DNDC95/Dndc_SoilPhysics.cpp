...
{	
    ...
    x = yr_avetj / 14.0;
    if (x < 0.0) x = 0.0;
    thorni = 30.0 * (1.0 + (float)pow(x, (float)2.0));
    if (thorni < 0.0) thorni = 0.0;
    A = (.49 + .0179 * thorni - .0000771 * (float)pow(thorni, (float)2.0) + .000000675 * (float)pow(thorni, (float)3.0));
    ...
    {    
        for ( l = 1; l <= q; l++ )
        {
            ...
            if(l<WTL)
            {
                ...
                TravelT = 0.5 * pow(clay[l],(float)1.9188)  * travelt;
